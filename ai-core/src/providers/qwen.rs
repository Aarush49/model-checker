...
const ID: &'static str = "model.qwen-3.5-4b";
...
impl ModelProvider for Qwen {
    ...
    async fn setup(
        ...
        let download_urls = vec![
            "https://huggingface.co/onnx-community/Qwen3.5-4B-ONNX/resolve/main/onnx/decoder_model_merged_q4.onnx".to_string(),
            "https://huggingface.co/onnx-community/Qwen3.5-4B-ONNX/resolve/main/onnx/decoder_model_merged_q4.onnx_data".to_string(),
            "https://huggingface.co/onnx-community/Qwen3.5-4B-ONNX/resolve/main/onnx/decoder_model_merged_q4.onnx_data_1".to_string(),
            "https://huggingface.co/onnx-community/Qwen3.5-4B-ONNX/resolve/main/onnx/embed_tokens_q4.onnx".to_string(),
            "https://huggingface.co/onnx-community/Qwen3.5-4B-ONNX/resolve/main/onnx/embed_tokens_q4.onnx_data".to_string(),
            "https://huggingface.co/onnx-community/Qwen3.5-4B-ONNX/resolve/main/generation_config.json".to_string(),
            "https://huggingface.co/onnx-community/Qwen3.5-4B-ONNX/resolve/main/config.json".to_string(),
            "https://huggingface.co/onnx-community/Qwen3.5-4B-ONNX/resolve/main/tokenizer.json".to_string(),
            "https://huggingface.co/onnx-community/Qwen3.5-4B-ONNX/resolve/main/tokenizer_config.json".to_string(),
            "https://huggingface.co/onnx-community/Qwen3.5-4B-ONNX/resolve/main/chat_template.jinja".to_string(),
            "https://huggingface.co/onnx-community/Qwen3.5-4B-ONNX/resolve/main/genai_config.json".to_string(),
        ];
    ...
    async fn ask(
        ...
        self.handler.ask(
            format!("<|im_start|>system\nYou are a helpful AI assistant. Keep answers short and concise.<|im_end|>\n<|im_start|>user\n{prompt}<|im_end|>\n<|im_start|>assistant\n"),
            config,
            tx,
        ).await
    }
